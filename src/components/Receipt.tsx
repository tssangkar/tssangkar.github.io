...
export default function Receipt({ data }: ReceiptProps) {
  ...
  let storeName = 'TS SANGKAR';
  let storeSlogan = 'Ahlinya Sangkar Burung Mentah Berkualitas';
  let storeDetailAlamat = '🌐 tssangkar.github.io | 📞 0851-1960-6906';
  let storeLogo = 'ts.png';
